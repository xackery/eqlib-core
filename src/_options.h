...
// isCpuSpeedFixEnabled was removed because of side effects. Instead check out https://github.com/xackery/eqlib-core/releases/tag/v0.0.1 and distribute EQGraphicsDX9.dll
...
bool areCustomNPCsEnabled = true;
...
static NPCEntry NPCs[] = {
    ...
    NPCEntry(733, 2, "DUG", 8, 1),
    NPCEntry(734, 2, "FOO", 8, 1),
};
